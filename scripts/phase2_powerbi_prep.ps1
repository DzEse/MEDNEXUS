...
$expected = @(
    ...
    "Maintenance.csv",
    "MORI.csv",
    "MORIComponentContributions.csv",
    ...
    "RootCauseSegments.csv",
    "RootCauseAssociations.csv",
    "RootCauseGroupTests.csv",
    "RootCauseRegression.csv",
    "RootCauseTreeImportance.csv",
    "RootCausePriorities.csv",
    "DemandForecast.csv",
    "DemandForecastBacktest.csv",
    "DemandForecastModelComparison.csv",
    "DemandForecastDiagnostics.csv",
    "Finance.csv",
    "Workforce.csv",
    "Recruitment.csv",
    "Supply.csv",
