...
| 42 | Testing & validation | IMPLEMENTED/PARTIAL | 48-test suite covering reproducibility, governance, KPI aggregation, FPY/SPC/loss gates, SQL reconciliation, ML temporal/model/threshold/calibration/explainability, root-cause CIs/FDR/effect tests/robust regression/VIF/tree, and rolling-origin forecast comparator/adequacy/reproducibility gates | MORI sensitivity, scenario/optimization/process gates and later analytics still require dedicated tests |
